        ...
        <section className="catalog-section catalog-training" id="training" aria-labelledby="training-title">
          ...
          <div className="training-grid">
            ...
            <article className="training-card training-card-onsite training-card-cerakote">
              <div>
                <div className="training-card-head"><span>04 / CERAMIC COATING</span><strong>1日・1社2名まで</strong></div>
                <h3>セラコート実技講習</h3>
              ...
              <div className="training-card-foot">
                ...
                <div className="training-price cerakote-training-price"><span>受講料</span><strong>220,000<small>円（税別）</small></strong></div>
                <p>1社2名まで同一料金。日程、会場、対象物、実習内容はお申し込み前に確認します。</p>
                <a className="button button-primary" href="/?equipment=cerakote#consult">セラコート講習を相談する</a>
              </div>
            </article>
          </div>
          <div className="cerakote-series-guide" aria-labelledby="cerakote-series-title">
            <div className="cerakote-series-heading">
              <div><p className="eyebrow eyebrow-dark">CERAKOTE SERIES GUIDE</p><h3 id="cerakote-series-title">代表シリーズ選定表</h3></div>
              <p>加熱硬化の可否、使用温度、必要性能から候補を絞り、最終的に製品番号ごとの最新資料を確認します。</p>
            </div>
            <div className="cerakote-series-scroll" tabIndex={0} aria-label="セラコート代表シリーズ選定表・横スクロールできます">
              <table className="cerakote-series-table">
                <thead><tr><th>シリーズ</th><th>硬化方法</th><th>主な選定用途</th><th>選定時の確認点</th></tr></thead>
                <tbody>
                  <tr><th scope="row"><strong>H</strong><span>H-Series</span></th><td><b>加熱硬化</b><small>金属の標準例：121°C（250°F）×2時間</small></td><td>耐摩耗性・耐食性を求める幅広い金属部品</td><td>色、基材、膜厚に合う硬化条件を製品別TDSで確認</td></tr>
                  <tr><th scope="row"><strong>C</strong><span>C-Series</span></th><td><b>常温硬化</b><small>代表例：指触乾燥45～60分、完全硬化5日</small></td><td>加熱しにくい部品、製品別の耐熱用途</td><td>耐熱温度はカラー・製品番号ごとに異なる</td></tr>
                  <tr><th scope="row"><strong>V</strong><span>V-Series</span></th><td><b>加熱硬化</b><small>代表例：149°C（300°F）×1時間、予熱工程あり</small></td><td>排気系・エンジン部品などの高温用途</td><td>対象部品、使用温度、製品適合を個別に確認</td></tr>
                </tbody>
              </table>
            </div>
            <p className="cerakote-series-note">※上記はCerakote公式資料に基づく代表条件です。実施工では製品番号、カラー、基材、用途ごとの最新TDS・SDS・Application Guideを確認します。
              <a href="https://www.cerakote.com/resources/files/training/Cerakote_ELITE_H-Series_Training_Manual_WEB_1-17-17.pdf" target="_blank" rel="noreferrer">H-Series公式資料</a>
              <a href="https://www.cerakote.com/resources/files/tech_sheets/C-140_BrightWhiteTDS.pdf" target="_blank" rel="noreferrer">C-Series公式資料</a>
              <a href="https://www.cerakote.com/resources/files/V-Series%20Application%20Guide.pdf" target="_blank" rel="noreferrer">V-Series公式資料</a>
            </p>
          </div>
